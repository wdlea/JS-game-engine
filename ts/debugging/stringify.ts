...
export function StringifyStats(): string {
    return `Took ${performance.now() - stats.startFrameTime}ms, ${stats.rendererCount} renderer(s), ${stats.indexCount} total indice(s), ${stats.meshDrawCalls} total draw call(s)`.toString()
}
/**
