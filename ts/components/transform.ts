...
export class Transform implements IComponent {
    ...
    private RecomputeRotation(cascade: boolean = true) {
        ...
        mat4.rotateY(this.rotatedMatrix, this.rotatedMatrix, this.rotationRAD[1])//second param used to be scaled matrix, bug
        mat4.rotateZ(this.rotatedMatrix, this.rotatedMatrix, this.rotationRAD[2])// ^
