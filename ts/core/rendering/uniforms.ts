...
const GLOBAL_SETTINGS_LENGTH = MAT4_LENGTH * 2;
/**
...
export class GlobalSettings implements ISettings {
    ...
    set ViewMatrix(v: mat4) {
        this.viewMatrixUpdated = true;
        this.viewMatrix = v;
    }

    /**
     * @param {mat4} cameraMatrix The Camera Matrix, represents the projection of the camera
     * @param {mat4} viewMatrix the viewmatrix, represents the position and rotation of the camera
     * @implements {ISettings}
     * @category Rendering
     */
    constructor(cameraMatrix: mat4, viewMatrix: mat4) {
    ...
    private RecomputeArray() {
        ...
        if (this.viewMatrixUpdated) {
            this.array.set(this.viewMatrix, MAT4_LENGTH)
        }
    }
